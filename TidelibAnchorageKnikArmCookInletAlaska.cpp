...
const float Amp[]  = {0.082,2.201,0.889,0.692,0.098,11.499,0.059,0.889,0.505,0.148,1.959,0.187,1.217,0.059,0.577,0.197,0.016,0.036,0.01,3.205,0.066,0.007,0.177,0.305,0.696,0.564,0.046,0.269,0.325,0.315,0.574,0.187,0.082,0.443,0.167,0.315,0.079};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const float Kappa[]  = {65.2,342.1,138.1,125.2,40.2,105.2,148,80.7,18.2,346.2,79.2,48.1,325,79.3,340.9,330.6,328.4,233.5,74.2,147.4,207,278.4,128.7,111.1,234,82.3,296.2,8.8,21.2,60,128.2,348.6,94.7,39.6,36.1,217.4,283};
...
const unsigned long startSecs[] PROGMEM = {1609455600,1640991600,1672527600,1704063600,1735686000,1767222000,1798758000,1830294000,1861916400,1893452400};

// 1st year of data in the Equilarg/Nodefactor/startSecs arrays.
const unsigned int startYear = 2021;
//------------------------------------------------------------------
